...
import library.yangshijing.constant.SQLCommand;
import library.yangshijing.util.DBOperator;
import library.yangshijing.util.Pair;
import library.yangshijing.view.ChartGenerator;
...
public class CheckoutActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.checkout_yangshijing);
        ...
        Button backBtn = (Button) this.findViewById(R.id.goBack_btn2);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.checkout_btn) {
            ...
            Toast.makeText(getBaseContext(), "Return successfully",
                    Toast.LENGTH_SHORT).show();
        } else if (id == R.id.goBack_btn2) {
            // Go back to main screen
            Intent intent = new Intent(this, YangShijingActivity.class);
            ...
            Intent intent = ChartGenerator.getBarChart(getBaseContext(),
                    "Checkout Summary in 2017", pairList);
            this.startActivity(intent);
        }
    }
